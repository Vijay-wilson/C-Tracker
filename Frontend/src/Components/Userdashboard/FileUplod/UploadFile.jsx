                ...
                <div className="col-xl-9">
                    <div className="card" style={{borderRadius: "15px",width:"100%",backgroundColor:"#f0f0f0"}}>
                        <div className="card-body">
                          <h3 style={{fontSize:'1.5rem', marginLeft:'28rem'}}>Upload Curriculum</h3>
                            ...
                            <div className="row align-items-center py-3">
                                <div className="col-md-3 ps-5">
                                    <h6 className="mb-0">Upload Curriculum</h6>
                                </div>
                                <div className="col-md-9 pe-5">
                                ...
                                <div className="px-5 py-4">
                                    <button type="submit" className="btn btn-primary btn-lg" onClick={uploadFile} >Upload</button>
                                </div>
                            </div>
                        </div>
                    </div>
