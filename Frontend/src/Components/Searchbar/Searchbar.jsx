...
const Searchbar = () => {
  ...
  const apiurl="http://localhost:3005/api/SearchRequirements"
    ...
    <div className="container-fluid ps-0">
       <div className="row g-3">
               ...
               <a
                 ...
                 <div className='search'>
                    <div className='searchInputs'>
                      <input type="text" name='reqname' placeholder='Search by name'  onChange={changeInput} style={{ display: 'inline-block',width:'13rem', fontSize:'smaller', marginLeft:'1rem' }} />
                  ...
                  <div className='search'>
                    <div className='searchInputs'>
                      <input type="text" name='catagory' placeholder='Search by category'  onChange={changeInput} style={{ display: 'inline-block',width:'13rem', fontSize:'smaller', marginLeft:'1rem' }} />
                      <div className='searchIcon' onClick={searchbtnclick} style={{ display: 'inline-block' }} > <SearchIcon/>
                  </div>
                  </div>
                </div>
        ...
        <div className="col col-12 col-sm-12 col-md-12 col-lg-9 col-xl-9 col-xxl-9">
                  ...
                  <h3 style={{marginLeft: '25rem', marginTop:'2%'}}>Requirements</h3>
